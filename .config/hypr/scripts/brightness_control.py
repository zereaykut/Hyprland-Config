...
def main():
    ...
    parser = argparse.ArgumentParser(description="Control brightness and send notifications.")
    parser.add_argument("-a", "--action", help="Action to increase or decrease brightness by 5%", required=True)
