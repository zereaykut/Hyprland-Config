...
def sddm(
    ...
    with open(f"{home}/.config/theme-manager/conf/sddm_theme_base.conf", "r", encoding="UTF-8") as f:
        sddm_theme = f.read()
    ...
    with open(f"{home}/.config/theme-manager/conf/sddm_theme.conf", "w", encoding="UTF-8") as file:
        file.write(sddm_theme)

    with open(f"{home}/.config/theme-manager/conf/sddm_base.conf", "r", encoding="UTF-8") as f:
        sddm_config = f.read()
    ...
    with open(f"{home}/.config/theme-manager/conf/sddm.conf", "w", encoding="UTF-8") as file:
        file.write(sddm_config)

    sp.run(["pkexec", "cp", f"{home}/.config/theme-manager/conf/sddm_theme.conf", "/usr/share/sddm/themes/Simple-SDDM/theme.conf"])
    sp.run(["pkexec", "cp", f"{home}/.config/theme-manager/conf/sddm.conf", "/etc/sddm.conf"])
