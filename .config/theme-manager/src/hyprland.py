...
def hyprland(config: dict, color_config: dict, theme: str, cursor_size: int, home: str) -> None:
    with open(f"{home}/.config/theme-manager/conf/hyprland_theme.conf", "r", encoding="UTF-8") as f:
